...
charlson_score <- read_dta("F:/projects/telederm/data/ml_ready/MEPS_2020_2022_charlson_score.dta")

#you need to unselect the variables to save derm_fyc; aka the not summary dataframe but still need to think 
#
